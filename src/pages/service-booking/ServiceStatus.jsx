...
export default function ServiceStatus() {
	...
	const loadBookings = () => {
		...
		return [...localBookings, ...mockBookings].sort((a, b) => {
	...
	// Reload bookings when component mounts
	useEffect(() => {
		setBookings(loadBookings());
	}, []);
	...
	const isNewBooking = (booking) => {
		...
		return diffInMinutes < 60; // New if created within last hour
	};
			...
			<div className="service-status py-5 bg-light">
				<div className="container">
					...
					<div className="text-center mb-5">
						...
						>
							<i className="fa fa-sync-alt me-1"></i>Refresh Bookings
						</button>
					</div>
					...
					<div className="mb-3">
						<small className="text-muted">
							Showing {filteredBookings.length} of {bookings.length} service
							bookings
						</small>
					</div>
								...
								<div key={booking.id} className="col-lg-6 mb-4">
									<div
										className={`card shadow h-100 border-0 ${
											isNewBooking(booking) ? "border-success border-2" : ""
										}`}
									>
												...
												<div>
													<h5 className="mb-1">
														...
														{isNewBooking(booking) && (
															<span className="badge bg-success ms-2 animate__animated animate__pulse animate__infinite">
																NEW
															</span>
														)}
													</h5>
													<small className="text-muted">
														Last updated{" "}
														{formatLastUpdated(booking.lastUpdated)}
													</small>
												</div>
										...
										<div className="card-body">
											<div className="row">
												<div className="col-md-6">
													...
													<div className="mb-2">
														<strong className="text-primary">
															<i className="fa fa-calendar me-1"></i>Preferred
															Date:
														</strong>
														<p className="mb-1">
												...
												<div className="col-md-6">
													...
													<div className="mb-2">
														<strong className="text-primary">
															<i className="fa fa-clock me-1"></i>Est.
															Completion:
														</strong>
														<p className="mb-1">
															{formatDate(booking.estimatedCompletion)}
														</p>
													</div>
													<div className="mb-2">
														<strong className="text-primary">
