...
export default function Slider1({ carItem }) {
	...
	useEffect(() => {
		const lightbox = new PhotoSwipeLightbox({
			gallery: "#my-gallery", // Unique ID for the gallery
			children: "a.image", // Target only the main image links
			...
			{carItem.images?.map((elm, i) => (
				<SwiperSlide key={i} className="swiper-slide">
					<div className="image-list-details">
                        ...
                        >
                            <img
                                ...
                                style={{
                                    ...
                                    height: "900px", // Change this value to customize the height
						...
						<a
							href={elm.image_url}
							data-pswp-width={imageSizes[elm.image_url]?.width || 800}
							data-pswp-height={imageSizes[elm.image_url]?.height || 600}
							target="_blank"
						...
						<div className="specs-features-wrap flex-three">
							<a className="specs-features" onClick={() => setShowVideo(true)}>
								<div className="icon">
									<svg
										width={18}
										height={14}
							...
							{showVideo && (
								<div className="video-player-wrapper">
									<ReactPlayer
										url="https://www.youtube.com/embed/dXM2yctgDtE?si=aK3-KQPLA_528Yh7"
										playing
										controls
										width="701px"
							...
							<a
								...
								onClick={(e) => {
									e.preventDefault();
									const parent = e.currentTarget.closest(".image-list-details");
									const mainImageLink = parent.querySelector("a.image");
									if (mainImageLink) mainImageLink.click();
								}}
							>
								<div className="icon">
									<svg
