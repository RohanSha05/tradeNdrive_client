...
export default function SoldCars({ parentClass = "tf-section-sold-cars" }) {
    const { carListings, bodyTypes } = useApi();
    const { data } = carListings;
    const { data: bodyTypeData } = bodyTypes;
    console.log("home car data", data);
    ...
    useEffect(() => {
        ...
        const filteredData = data.filter((item) => item.status === "Sold Car");
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="flex justify-space px-4">
                            ...
                            >
                                Recently Sold Cars 
                                <span className="badge badge-success ms-2">Sold</span>
                            </h2>
                            <div className="flex-six gap-20 flex-wrap">
                                <a
                                    href="car-list?status=Sold Car"
                                                ...
                                                <div className="image-group relative">
                                                    <div className="top flex-two">
                                                        <ul className="d-flex gap-8">
                                                            ...
                                                            <li className="flag-tag-success style-1">
                                                                <div className="icon">
                                                                    <svg
                                                                        width={16}
                                                                        height={13}
                                                        ...
                                                        <div className="year flag-tag-success">{car.year}</div>
                                                    </div>
