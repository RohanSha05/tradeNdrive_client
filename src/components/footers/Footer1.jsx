...
import { getFooterData } from "@/data/footerLinks";
...
export default function Footer1() {
	...
	const footerData = getFooterData(description1, carBrands?.data);
	...
	useEffect(() => {
		if (secondary_logo && secondary_logo.trim() !== "") {
			setLogoSrc(secondary_logo);
		}
	}, [secondary_logo]);
					...
					<div className="row">
						<div className="col-lg-3 col-6">
							<div className="box-footer-top flex-three">
								...
								<div className="content">
									<h5 className="title">Top 1 in Saskatoon</h5>
									<p>Quality Cars & Reliable Repairs</p>
								</div>
							</div>
						</div>
						<div className="col-lg-3 col-6">
							<div className="box-footer-top flex-three">
								...
								<div className="content">
									<h5 className="title">Drive Away Today</h5>
									<p>Purchase Cars Immediately</p>
								</div>
							</div>
						</div>
						<div className="col-lg-3 col-6">
							<div className="box-footer-top flex-three">
								...
								<div className="content">
									<h5 className="title">Unbeatable Deals</h5>
						...
						<div className="col-lg-3 col-6">
							<div className="box-footer-top flex-three">
								...
								<div className="content">
									<h5 className="title">Smart Car Shopping</h5>
									<p>Compare, Choose & Drive with Confidence</p>
								</div>
							</div>
						</div>
					</div>
								...
								<div className="widget widget-menu footer-col-block">
									...
									<ul className="box-menu tf-collapse-content">
										{column.menuItems.map((item, itemIndex) => (
											<li key={itemIndex}>
												<Link to={`/car-list?car_brand=${item.id}`}>
													{item.text}
												</Link>
											</li>
										))}
								...
								<ul className="box-menu tf-collapse-content">
									<li>
										<a href="#" className="flex gap-2">
											<i className="icon-autodeal-engine footer-icon" />
											<span className="">
												{site_title ? site_title : "Isam Auto"}
											</span>
										</a>
									</li>
									<li>
										<a href="#" className="flex gap-2">
											<i className="icon-autodeal-phone2 footer-icon" />
											{contact_number ? contact_number : "1 306 974 4820"}
										</a>
									</li>
									<li>
										<a href="#" className="flex gap-2">
											<i className="icon-autodeal-mail footer-icon" />
											{contact_email ? contact_email : "contact@isamauto.ca"}
										</a>
									</li>
									<li>
										<a href="#" className="flex gap-2">
											<i className="icon-autodeal-city footer-icon" />
											{address ? address : "1009 20th St. W, Saskatoon S7M0Y6"}
										</a>
									</li>
								</ul>
							</div>
				...
				<div className="footer-bottom">
					<div className="row">
						<div className="col-lg-4 col-md-12">
							<div className="logo-footer style box-1 flex gap-5">
								<Link to={`/`}>
									<img
										className="lazyload"
						...
						<div className="col-lg-8 col-md-12">
							<div className="footer-bottom-right flex-six flex-wrap">
								<div className="title-bottom center">
									© {currentYear} Isam Auto. All rights reserved
								</div>
								{(facebook || linkedin || x || instagram || youtube) && (
									<div className="icon-social box-3 text-color-1">
										{(facebook || "https://www.facebook.com/isamauto") && (
											<a href={facebook || "https://facebook.com/default"}>
												<i className="icon-autodeal-facebook" />
											</a>
										)}
										{(linkedin ||
											"https://www.linkedin.com/company/isamauto/") && (
											<a href={linkedin || "https://linkedin.com/default"}>
										...
										{(instagram || "https://www.instagram.com/isamauto/#") && (
											<a href={instagram || "https://instagram.com/default"}>
