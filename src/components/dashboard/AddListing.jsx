...
export default function AddListing() {
	...
	const handleSubmit = (e) => {
		...
		checkboxes.forEach((checkbox) => {
			data[checkbox.nextElementSibling.textContent.trim()] = checkbox.checked;
		});
	};
									...
									<div className="tfcl-add-listing car-details">
										...
										<div className="tfcl-add-listing car-details">
											...
											<div className="row">
												...
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Car Brand 1", "Car Brand 2"]}
														/>
													</div>
												</div>
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Body Type 1", "Body Type 2"]}
														/>
													</div>
												</div>
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Fuel Type 1", "Fuel Type 2"]}
														/>
													</div>
												</div>
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Drive Type 1", "Drive Type 2"]}
														/>
													</div>
												</div>
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Gear Type 1", "Gear Type 2"]}
														/>
													</div>
												</div>
												<div className="col-md-4">
												...
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Car Model 1", "Car Model 2"]}
														/>
													</div>
												</div>
												<div className="col-md-4">
												...
												<div className="col-md-4">
													<div className="form-group">
														<label htmlFor="monthly_installment_price">
														...
														<input
															...
															placeholder="Enter monthly installment price"
															defaultValue=""
														/>
													</div>
												</div>
												<div className="col-md-4">
													<div className="form-group">
														<label htmlFor="installment_month">
															Installment Month
														</label>
														<input
															type="number"
															...
															placeholder="Enter installment month"
															defaultValue=""
														/>
													</div>
												</div>
												...
												<div className="col-md-4">
													<div className="form-group">
														<label htmlFor="comfort_convenience">
															Comfort & Convenience
														</label>
														<textarea
															className="form-control"
															name="comfort_convenience"
															placeholder="Enter comfort & convenience details"
															defaultValue=""
														/>
													</div>
												</div>
												...
												<div className="col-md-4">
													<div className="form-group">
														<label htmlFor="entertainment_communication">
															Entertainment & Communication
														</label>
														<textarea
															className="form-control"
															name="entertainment_communication"
															placeholder="Enter entertainment & communication details"
															defaultValue=""
														/>
													</div>
												</div>
												<div className="col-md-4">
													<div className="form-group">
														...
														<DropdownSelect
															addtionalParentClass="form-control"
															defaultOption={"Select"}
															options={["Pending", "On Sale", "Booked", "Sold"]}
														/>
													</div>
												</div>
											</div>
